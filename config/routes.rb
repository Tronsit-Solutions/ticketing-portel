Rails.application.routes.draw do
  ...
  delete "hiring_detail",          to: "hiring_details#cancel_pending",   as: :cancel_pending_hiring_detail
  ...
  delete "termination_detail",     to: "termination_details#cancel_pending", as: :cancel_pending_termination_detail
